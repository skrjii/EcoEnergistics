...
public class ItemSolarCellsAvaritia extends ItemMEE implements IMetaItem {

    public ItemSolarCellsAvaritia() {
        super();
        setHasSubtypes(true);
    }
    ...
    public String getTexture(int meta) {
        return AvaritiaTiers.values()[meta].getSimpleName() + "SolarCell";
    }
    ...
    public String getTranslationKey(ItemStack item) {
        return "item." + AvaritiaTiers.values()[item.getItemDamage()].getSimpleName() + "SolarCell";
    }
}