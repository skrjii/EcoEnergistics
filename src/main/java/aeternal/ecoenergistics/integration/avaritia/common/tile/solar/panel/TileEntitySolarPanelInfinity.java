package aeternal.ecoenergistics.integration.avaritia.common.tile.solar.panel;
...
public class TileEntitySolarPanelInfinity extends TileEntityEcoGenerator {
    ...
    public TileEntitySolarPanelInfinity() {
        this("SolarPanelInfinity", 1119888000, AvaritiaSolarConfig.InfinityGen_S.getValue());
    }
    ...
    protected float getConfiguredMax() {
        return (float) AvaritiaSolarConfig.InfinityGen_S.getValue();
    }
