package aeternal.ecoenergistics.integration.avaritia.client.model;
...
public class ModelSolarStationAvaritia extends ModelBase {
    ...
    public ModelSolarStationAvaritia() {
        textureWidth = 256;
        textureHeight = 256;
