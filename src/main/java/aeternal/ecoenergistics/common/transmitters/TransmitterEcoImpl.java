package aeternal.ecoenergistics.common.transmitters;
...
public class TransmitterEcoImpl<ACCEPTOR, NETWORK extends DynamicNetwork<ACCEPTOR, NETWORK, BUFFER>, BUFFER> extends Transmitter<ACCEPTOR, NETWORK, BUFFER> {

    public TileEntityEcoTransmitter<ACCEPTOR, NETWORK, BUFFER> containingTile;

    public TransmitterEcoImpl(TileEntityEcoTransmitter<ACCEPTOR, NETWORK, BUFFER> multiPart) {
    ...
    public boolean isCompatibleWith(IGridTransmitter<ACCEPTOR, NETWORK, BUFFER> other) {
        if (other instanceof TransmitterEcoImpl) {
            return containingTile.isValidTransmitter(((TransmitterEcoImpl) other).containingTile);
        }
    ...
    public boolean isValid() {
        TileEntityEcoTransmitter cont = getTileEntity();
        if (cont == null) {
            return false;
        }
    ...
    public void setTileEntity(TileEntityEcoTransmitter<ACCEPTOR, NETWORK, BUFFER> containingPart) {
