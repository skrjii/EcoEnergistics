...
public class ItemBlockGeneratorAdd extends ItemBlock implements IEnergizedItem, ISpecialElectricItem, ISustainedInventory, /*ISustainedTank,*/ IEnergyContainerItem, ISecurityItem {

    public Block metaBlock;

    public ItemBlockGeneratorAdd(Block block) {
        super(block);
        metaBlock = block;
        setHasSubtypes(true);
    }
    ...
    public int getItemStackLimit(ItemStack stack) {
        EcoGeneratorTypeAdd type = EcoGeneratorTypeAdd.get(stack);
    ...
    public String getTranslationKey(ItemStack itemstack) {
        EcoGeneratorTypeAdd ecogeneratorType = EcoGeneratorTypeAdd.get(itemstack);
        if (ecogeneratorType == null) {
            return "KillMe!";
        }
        return getTranslationKey() + "." + ecogeneratorType.getBlockName();
    ...
    public void addInformation(@Nonnull ItemStack itemstack, World world, @Nonnull List<String> list, @Nonnull ITooltipFlag flag) {
        EcoGeneratorTypeAdd type = EcoGeneratorTypeAdd.get(itemstack);
        if (type == null) {
            return;
        }
        if (type.maxEnergy > -1) {
    ...
    public boolean placeBlockAt(@Nonnull ItemStack stack, @Nonnull EntityPlayer player, World world, @Nonnull BlockPos pos, EnumFacing side, float hitX, float hitY,
        ...
        if (stack.getItemDamage() == EcoGeneratorTypeAdd.SOLAR_STATION_ADVANCED.meta && stack.getItemDamage() == EcoGeneratorTypeAdd.SOLAR_STATION_HYBRID.meta && stack.getItemDamage() == EcoGeneratorTypeAdd.SOLAR_STATION_PERFECTHYBRID.meta && stack.getItemDamage() == EcoGeneratorTypeAdd.SOLAR_STATION_QUANTUM.meta && stack.getItemDamage() == EcoGeneratorTypeAdd.SOLAR_STATION_SPECTRAL.meta && stack.getItemDamage() == EcoGeneratorTypeAdd.SOLAR_STATION_SINGULAR.meta && stack.getItemDamage() == EcoGeneratorTypeAdd.SOLAR_STATION_PROTONIC.meta && stack.getItemDamage() == EcoGeneratorTypeAdd.SOLAR_STATION_SINGULAR.meta && stack.getItemDamage() == EcoGeneratorTypeAdd.SOLAR_STATION_DIFFRACTIVE.meta && stack.getItemDamage() == EcoGeneratorTypeAdd.SOLAR_STATION_PHOTONIC.meta && stack.getItemDamage() == EcoGeneratorTypeAdd.SOLAR_STATION_NEUTRON.meta) {
    ...
    public double getMaxEnergy(ItemStack itemStack) {
        EcoGeneratorTypeAdd ecogeneratorType = EcoGeneratorTypeAdd.get(itemStack);
        return ecogeneratorType != null ? ecogeneratorType.maxEnergy : 0;
    }
    ...
    public boolean canSend(ItemStack itemStack) {
        EcoGeneratorTypeAdd ecogeneratorType = EcoGeneratorTypeAdd.get(itemStack);
        return ecogeneratorType != null && ecogeneratorType.maxEnergy != -1;
    }
