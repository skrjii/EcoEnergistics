...
public class ItemBlockGenerator extends ItemBlock implements IEnergizedItem, ISpecialElectricItem, ISustainedInventory, /*ISustainedTank,*/ IEnergyContainerItem, ISecurityItem {
    ...
    public String getTranslationKey(ItemStack itemstack) {
        EcoGeneratorType ecogeneratorType = EcoGeneratorType.get(itemstack);
    ...
    public boolean placeBlockAt(@Nonnull ItemStack stack, @Nonnull EntityPlayer player, World world, @Nonnull BlockPos pos, EnumFacing side, float hitX, float hitY,
        ...
        /*if (stack.getItemDamage() == EcoGeneratorType.SOLAR_STATION_ADVANCED.meta && stack.getItemDamage() == EcoGeneratorType.SOLAR_STATION_HYBRID.meta && stack.getItemDamage() == EcoGeneratorType.SOLAR_STATION_PERFECTHYBRID.meta && stack.getItemDamage() == EcoGeneratorType.SOLAR_STATION_QUANTUM.meta && stack.getItemDamage() == EcoGeneratorType.SOLAR_STATION_SPECTRAL.meta && stack.getItemDamage() == EcoGeneratorType.SOLAR_STATION_SINGULAR.meta && stack.getItemDamage() == EcoGeneratorType.SOLAR_STATION_PROTONIC.meta && stack.getItemDamage() == EcoGeneratorType.SOLAR_STATION_SINGULAR.meta && stack.getItemDamage() == EcoGeneratorType.SOLAR_STATION_DIFFRACTIVE.meta && stack.getItemDamage() == EcoGeneratorType.SOLAR_STATION_PHOTONIC.meta && stack.getItemDamage() == EcoGeneratorType.SOLAR_STATION_NEUTRON.meta) {
