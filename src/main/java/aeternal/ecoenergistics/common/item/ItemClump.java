...
public class ItemClump extends ItemMEE implements IMetaItem {
    ...
    public String getTexture(int meta) {
        return Dust.values()[meta].getName() + "Clump";
    }
    ...
    public String getTranslationKey(ItemStack item) {
        return "item." + Dust.values()[item.getItemDamage()].getName().toLowerCase(Locale.ROOT) + "Clump";
    }
