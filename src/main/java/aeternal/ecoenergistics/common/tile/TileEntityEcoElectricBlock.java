...
public abstract class TileEntityEcoElectricBlock extends TileEntityEcoContainerBlock implements IEnergyWrapper {
     ...
     */
    public TileEntityEcoElectricBlock(String name, double baseMaxEnergy) {
        super(name);
