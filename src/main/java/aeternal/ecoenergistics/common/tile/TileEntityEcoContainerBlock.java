...
public abstract class TileEntityEcoContainerBlock extends TileEntityEcoBasicBlock implements ISidedInventory, ISustainedInventory, ITickable, IToggleableCapability {
     ...
     */
    public TileEntityEcoContainerBlock(String name) {
        fullName = name;
    }
