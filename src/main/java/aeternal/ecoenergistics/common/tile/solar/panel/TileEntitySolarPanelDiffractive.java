...
public class TileEntitySolarPanelDiffractive extends TileEntityEcoGenerator {
    ...
    public TileEntitySolarPanelDiffractive() {
        this("SolarPanelDiffractive", 24576000, SolarConfig.DiffractiveGen_S.getValue());
    }

    public TileEntitySolarPanelDiffractive(String name, double maxEnergy, double output) {
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.DiffractiveGen_S.getValue();
    }
