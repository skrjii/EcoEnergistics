...
public class TileEntitySolarStationPerfectHybrid extends TileEntitySolarPanelAdvanced implements IBoundingBlock, IEvaporationSolar {

    public TileEntitySolarStationPerfectHybrid() {
        super("SolarStationPerfectHybrid", 7200000, SolarConfig.PerfectHybridGen_SS.getValue());
    }
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.PerfectHybridGen_SS.getValue();
    }
