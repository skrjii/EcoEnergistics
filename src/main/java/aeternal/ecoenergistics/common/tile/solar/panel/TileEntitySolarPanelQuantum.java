...
public class TileEntitySolarPanelQuantum extends TileEntityEcoGenerator {
    ...
    public TileEntitySolarPanelQuantum() {
        this("SolarPanelQuantum", 1536000, SolarConfig.QuantumGen_S.getValue());
    }

    public TileEntitySolarPanelQuantum(String name, double maxEnergy, double output) {
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.QuantumGen_S.getValue();
    }
