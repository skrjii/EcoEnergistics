...
public class TileEntitySolarStationPhotonic extends TileEntitySolarPanelAdvanced implements IBoundingBlock, IEvaporationSolar {

    public TileEntitySolarStationPhotonic() {
        super("SolarStationPhotonic", 552960000, SolarConfig.PhotonicGen_SS.getValue());
    }
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.PhotonicGen_SS.getValue();
    }
