...
public class TileEntitySolarPanelSpectral extends TileEntityEcoGenerator {
    ...
    public TileEntitySolarPanelSpectral() {
        this("SolarPanelSpectral", 3072000, SolarConfig.SpectralGen_S.getValue());
    }

    public TileEntitySolarPanelSpectral(String name, double maxEnergy, double output) {
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.SpectralGen_S.getValue();
    }
