...
public class TileEntitySolarPanelAdvanced extends TileEntityEcoGenerator {
    ...
    public TileEntitySolarPanelAdvanced() {
        this("SolarPanelAdvanced", 192000, SolarConfig.AdvancedGen_S.getValue());
    }

    public TileEntitySolarPanelAdvanced(String name, double maxEnergy, double output) {
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.AdvancedGen_S.getValue();
    }
