...
public class TileEntitySolarStationProtonic extends TileEntitySolarPanelAdvanced implements IBoundingBlock, IEvaporationSolar {

    public TileEntitySolarStationProtonic() {
        super("SolarStationProtonic", 8640000, SolarConfig.ProtonicGen_SS.getValue());
    }
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.ProtonicGen_SS.getValue();
    }
