...
public class TileEntitySolarStationNeutron extends TileEntitySolarPanelAdvanced implements IBoundingBlock, IEvaporationSolar {

    public TileEntitySolarStationNeutron() {
        super("SolarStationNeutron", 663552000, SolarConfig.NeutronGen_SS.getValue());
    }
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.NeutronGen_SS.getValue();
    }
