...
public class TileEntitySolarStationAdv extends TileEntitySolarPanelAdvanced implements IBoundingBlock, IEvaporationSolar {

    public TileEntitySolarStationAdv() {
        super("SolarStationAdvanced", 800000, SolarConfig.AdvancedGen_SS.getValue());
    }
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.AdvancedGen_SS.getValue();
    }
