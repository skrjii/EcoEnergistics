...
public class TileEntitySolarPanelProtonic extends TileEntityEcoGenerator {
    ...
    public TileEntitySolarPanelProtonic() {
        this("SolarPanelProtonic", 6144000, SolarConfig.ProtonicGen_S.getValue());
    }

    public TileEntitySolarPanelProtonic(String name, double maxEnergy, double output) {
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.ProtonicGen_S.getValue();
    }
