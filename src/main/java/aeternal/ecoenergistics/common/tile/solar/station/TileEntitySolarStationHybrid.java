...
public class TileEntitySolarStationHybrid extends TileEntitySolarPanelAdvanced implements IBoundingBlock, IEvaporationSolar {

    public TileEntitySolarStationHybrid() {
        super("SolarStationHybrid", 2400000, SolarConfig.HybridGen_SS.getValue());
    }
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.HybridGen_SS.getValue();
    }
