...
public class TileEntitySolarStationDiffractive extends TileEntitySolarPanelAdvanced implements IBoundingBlock, IEvaporationSolar {

    public TileEntitySolarStationDiffractive() {
        super("SolarStationDiffractive", 138240000, SolarConfig.DiffractiveGen_SS.getValue());
    }
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.DiffractiveGen_SS.getValue();
    }
