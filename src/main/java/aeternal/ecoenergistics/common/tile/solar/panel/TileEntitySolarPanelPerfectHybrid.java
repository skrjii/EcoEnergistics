...
public class TileEntitySolarPanelPerfectHybrid extends TileEntityEcoGenerator {
    ...
    public TileEntitySolarPanelPerfectHybrid() {
        this("SolarPanelPerfectHybrid", 768000, SolarConfig.PerfectHybridGen_S.getValue());
    }

    public TileEntitySolarPanelPerfectHybrid(String name, double maxEnergy, double output) {
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.PerfectHybridGen_S.getValue();
    }
