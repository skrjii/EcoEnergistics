...
public class TileEntitySolarStationSingular extends TileEntitySolarPanelAdvanced implements IBoundingBlock, IEvaporationSolar {

    public TileEntitySolarStationSingular() {
        super("SolarStationSingular", 34560000, SolarConfig.SingularGen_SS.getValue());
    }
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.SingularGen_SS.getValue();
    }
