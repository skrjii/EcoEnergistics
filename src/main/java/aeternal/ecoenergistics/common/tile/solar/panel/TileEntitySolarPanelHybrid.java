...
public class TileEntitySolarPanelHybrid extends TileEntityEcoGenerator {
    ...
    public TileEntitySolarPanelHybrid() {
        this("SolarPanelHybrid", 384000, SolarConfig.HybridGen_S.getValue());
    }

    public TileEntitySolarPanelHybrid(String name, double maxEnergy, double output) {
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.HybridGen_S.getValue();
    }
