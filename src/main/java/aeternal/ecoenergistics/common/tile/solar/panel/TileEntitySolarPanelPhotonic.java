...
public class TileEntitySolarPanelPhotonic extends TileEntityEcoGenerator {
    ...
    public TileEntitySolarPanelPhotonic() {
        this("SolarPanelPhotonic", 49152000, SolarConfig.PhotonicGen_S.getValue());
    }

    public TileEntitySolarPanelPhotonic(String name, double maxEnergy, double output) {
    ...
    protected float getConfiguredMax() {
        return (float) SolarConfig.PhotonicGen_S.getValue();
    }
