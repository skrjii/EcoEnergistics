...
public abstract class TileEntityEcoEffectsBlock extends TileEntityEcoElectricBlock implements IActiveState {
     ...
     */
    public TileEntityEcoEffectsBlock(String sound, String name, double baseMaxEnergy) {
    ...
    public TileEntityEcoEffectsBlock(String sound, String name, double baseMaxEnergy, int rapidChangeThreshold) {
