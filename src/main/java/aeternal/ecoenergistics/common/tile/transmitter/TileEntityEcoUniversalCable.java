...
public class TileEntityEcoUniversalCable extends TileEntityEcoTransmitter<EnergyAcceptorWrapper, EnergyNetwork, EnergyStack> implements IStrictEnergyAcceptor,
        IStrictEnergyStorage, IEnergyReceiver {

    public EcoCableTier tier = EcoCableTier.ADVANCED;
    ...
    public void setBaseTier(MEETiers baseTier) {
        tier = EcoCableTier.get(baseTier);
    }
    ...
    public EcoTransmitterType getTransmitterType() {
        return EcoTransmitterType.UNIVERSAL_CABLE;
    }
    ...
    public void readFromNBT(NBTTagCompound nbtTags) {
        ...
        if (nbtTags.hasKey("tier")) {
            tier = EcoCableTier.values()[nbtTags.getInteger("tier")];
        }
    }
    ...
    public void handlePacketData(ByteBuf dataStream) throws Exception {
        tier = EcoCableTier.values()[dataStream.readInt()];
