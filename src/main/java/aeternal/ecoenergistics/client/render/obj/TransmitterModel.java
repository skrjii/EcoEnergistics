...
public class TransmitterModel extends OBJBakedModelBase {
    ...
    public static void registerIcons(TextureMap map) {
        transporter_center[0] = map.registerSprite(new ResourceLocation(Constants.MOD_ID, "blocks/models/multipart/LogisticalTransporterGlass"));
        transporter_center_color[0] = map.registerSprite(new ResourceLocation(Constants.MOD_ID, "blocks/models/multipart/LogisticalTransporterGlassColored"));
        transporter_side[0] = map.registerSprite(new ResourceLocation(Constants.MOD_ID, "blocks/models/multipart/LogisticalTransporterVerticalGlass"));
        transporter_side_color[0] = map.registerSprite(new ResourceLocation(Constants.MOD_ID, "blocks/models/multipart/LogisticalTransporterVerticalGlassColored"));

        transporter_center[1] = map.registerSprite(new ResourceLocation(Constants.MOD_ID, "blocks/models/multipart/opaque/LogisticalTransporterGlass"));
        transporter_center_color[1] = map.registerSprite(new ResourceLocation(Constants.MOD_ID, "blocks/models/multipart/opaque/LogisticalTransporterGlassColored"));
        transporter_side[1] = map.registerSprite(new ResourceLocation(Constants.MOD_ID, "blocks/models/multipart/opaque/LogisticalTransporterVerticalGlass"));
        transporter_side_color[1] = map.registerSprite(new ResourceLocation(Constants.MOD_ID, "blocks/models/multipart/opaque/LogisticalTransporterVerticalGlassColored"));
    }
    ...
    public byte getIconStatus(EnumFacing side, PropertyConnection connection) {
        ConnectionType type = TileEntityEcoSidedPipe.getConnectionType(side, connection.connectionByte, connection.transmitterConnections, connection.connectionTypes);
