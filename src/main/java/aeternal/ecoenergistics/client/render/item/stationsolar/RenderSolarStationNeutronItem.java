...
public class RenderSolarStationNeutronItem extends RenderSolarStationsolarGeneratorItem {
    ...
    public static void renderStack(@Nonnull ItemStack stack, ItemCameraTransforms.TransformType transformType) {
        ...
        MekanismRenderer.bindTexture(EcoEnergisticsUtils.getResource(EcoEnergisticsUtils.ResourceType.RENDER, "NeutronSolarStation.png"));
