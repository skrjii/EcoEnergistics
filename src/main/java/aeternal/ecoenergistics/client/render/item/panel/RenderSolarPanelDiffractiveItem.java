...
public class RenderSolarPanelDiffractiveItem {
    ...
    public static void renderStack(@Nonnull ItemStack stack, TransformType transformType) {
        ...
        MekanismRenderer.bindTexture(Constants.getResource(Constants.ResourceType.RENDER, "DiffractiveSolarPanel.png"));
