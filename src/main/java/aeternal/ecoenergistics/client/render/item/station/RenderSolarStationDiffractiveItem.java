...
public class RenderSolarStationDiffractiveItem {
    ...
    public static void renderStack(@Nonnull ItemStack stack, TransformType transformType) {
        ...
        MekanismRenderer.bindTexture(Constants.getResource(Constants.ResourceType.RENDER, "DiffractiveSolarStation.png"));
