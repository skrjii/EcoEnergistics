...
public class RenderSolarPanelInfinityItem extends RenderSolarPanelGeneratorItem {
    ...
    public static void renderStack(@Nonnull ItemStack stack, ItemCameraTransforms.TransformType transformType) {
        ...
        MekanismRenderer.bindTexture(EcoEnergisticsUtils.getResource(EcoEnergisticsUtils.ResourceType.RENDER, "InfinitySolarPanel.png"));
