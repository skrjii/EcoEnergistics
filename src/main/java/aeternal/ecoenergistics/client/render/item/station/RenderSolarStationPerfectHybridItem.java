...
public class RenderSolarStationPerfectHybridItem {
    ...
    public static void renderStack(@Nonnull ItemStack stack, TransformType transformType) {
        ...
        MekanismRenderer.bindTexture(Constants.getResource(Constants.ResourceType.RENDER, "PerfectHybridSolarStation.png"));
